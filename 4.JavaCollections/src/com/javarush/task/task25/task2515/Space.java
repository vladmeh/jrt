...
//        bombs.removeIf(BaseObject::isAlive);
//        ufos.removeIf(BaseObject::isAlive);
//        rockets.removeIf(BaseObject::isAlive);

        for (BaseObject object : getAllItems())
        {
            if (object instanceof Bomb && !object.isAlive())
                bombs.remove(object);

            if (object instanceof Ufo && !object.isAlive())
                ufos.remove(object);

            if (object instanceof Rocket && !object.isAlive())
