...
Пример неконтролируемого переключения нитей при доступе к одному объекту.

Программа асинхронно запускает 10 нитей, которые сортируют один массив (один объект).
