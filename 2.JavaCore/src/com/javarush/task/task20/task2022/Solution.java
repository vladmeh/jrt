...
public class Solution implements Serializable, AutoCloseable {
    ...
    //вводим новую переменную в классе
    public String filename;

    public Solution(String fileName) throws FileNotFoundException {
        //инициализируем ее, она сохраняется при сериализации
    ...
    private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        //при восстановлении объекта, восстанавливаем переменную
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        Solution savedObject = new Solution("testfiles/serializable.txt");
        savedObject.writeObject("Старая строка");
        ...
        loadedObject.writeObject("Новая строка");
        in.close();
    }
}
