...
public class Solution {
    ...
    public static class Gamer extends Thread {
        ...
        public void run() {
            ...
            try {
                //Метод run класса Gamer через равные интервалы времени (1000ms / rating)
                // должен выводить в консоль фамилию игрока и действие
                for (String step: OnlineGame.steps){
                    Thread.sleep(1000/rating);
                    System.out.println(getName() + ":" + step);
                }

                //Когда все игровые шаги будут выполнены, а победитель еще не найден,
                // метод run должен установить флаг OnlineGame.isWinnerFound в true
                // (сообщить остальным, что он победитель).
                // обязательно проверить состояние флага OnlineGame.isWinnerFound
                ...
                //Методы run всех игроков которые не стали победителями (были прерваны),
                // должны вывести надписи [getName() + :проиграл]
