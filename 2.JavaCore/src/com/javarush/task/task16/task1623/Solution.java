...
public class Solution {
    ...
    public static class GenerateThread extends Thread{
        ...
        public GenerateThread(){
            //Конструктор класса GenerateThread должен увеличивать значение countCreatedThreads и передавать его
        ...
        @Override
        public void run() {
            //Если количество созданных нитей меньше Solution.count
            if (countCreatedThreads < Solution.count){
                //метод run должен создать новую нить типа GenerateThread.
                GenerateThread generateThread = new GenerateThread();
                //метод run должен вывести созданную нить в консоль.
                System.out.println(generateThread);
            }
        }

        //Метод toString класса GenerateThread должен возвращать имя нити и слово " created".
        @Override
